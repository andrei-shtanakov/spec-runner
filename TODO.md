...
- 🔭 **Репетиция нашла #282** — RED-промпт нигде не логируется, в отличие от
  ...
  релиза — пробел наблюдаемости, который старше него.
...
- 🧾 **Открыт только #285** (automatic REFACTORING, deferred, 0/3); #282
  (логирование RED-промпта) ждёт мержа. Всё остальное закрыто с перепроверкой
  на слитом дереве: #141, #252, #255, #260, #261, #263, #266, #267, #270, #273
  в этой волне; #218, #229, #230, #231, #232, #241, #245, #249, #253, #254,
  #256 раньше. У пяти формулировка находки поправлена в самом issue, потому что
  измерение назвало другую причину.
