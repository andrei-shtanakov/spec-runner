...
- ✅ **v2.35.0 выпущен и отрепетирован 2026-08-21** — одна точка расширения
  ...
  `923ec14` — конвенция репо), `publish.yml` (`32492421127`) success, PyPI 200
...
- ✅ **v2.34.0 выпущен и отрепетирован 2026-08-19** — обе половины #301 плюс
  ...
  Поверхности измерены: тег на релизном коммите `8e4a65e` (не на merge —
  конвенция репо), `publish.yml` success, PyPI 200 на per-version endpoint и
