...
- 🧾 **Открыты #141, #252, #255, #270 и #273.** #260, #261, #263, #266, #267
  закрыты с перепроверкой на слитом дереве и вышли в 2.32.0. #218, #229, #230, #231,
  #232, #241, #245, #249, #253, #254, #256 закрыты с перепроверкой на слитом
  дереве; у пяти из них формулировка находки поправлена в самом issue, потому
  что измерение назвало другую причину.
