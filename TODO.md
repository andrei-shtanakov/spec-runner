# TODO — spec-runner (план от 2026-04-16, обновлено 2026-08-13)
...
- 🔬 **Репетиция опубликованного артефакта нашла #273** — не регрессию релиза, а
  ...
  авторизации бюджета, red-чекпойнты и claims. Механизм измерен: `git rm
  --cached` в staging (он держит runtime-состояние вне коммитов) снимает файл с
  учёта, а следующая операция с деревом пишет поверх живого SQLite пустоту.
