...
## Текущее состояние
- 🚀 **`[Unreleased]` не пуст: три PR ждут релиза (2026-08-13).** #215 (#214 —
...
- ✅ **Закрыты как отгруженные (перепроверено по коду 2026-08-13):** #198, #207,
...
- [ ] **tdd-lifecycle-design** — #141 принят как **дизайн-трек**, не minor-релиз: @owner:github:andrei-shtanakov @id:tdd-lifecycle-design
      ...
      **Сбор evidence начат и пока не дал ни одной записи (2026-08-13).**
      ...
      и `.../2026-08-13-tdd-rehearsals.md`.
