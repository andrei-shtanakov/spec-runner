...
Whether a malformed selector is refused, or a verify-first task with no
declared group is refused, is BEH-04/BEH-05's contract (TASK-003), not this
one's — this slice only covers the declaration reaching `Task.verifies`
unchanged (or staying empty when absent).
"""
