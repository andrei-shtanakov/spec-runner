...
OpenSpec-inspired spec lifecycle: this release ports the four patterns worth
borrowing from OpenSpec (studied 2026-07-13) — per-stage prompt context/rules,
a structured requirements parser, DAG stage profiles, change-as-folder, and
