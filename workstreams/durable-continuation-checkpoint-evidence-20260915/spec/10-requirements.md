...
- **Синхронный ack mutation-checkpoint-а у подкоманд без платного вызова.**
  ...
  то, ради чего формулировка и писалась: число ожиданий не зависит от числа
  mutation подкоманды, и ни одно из них не наступает **между записями**
  многошагового handler-а — ни `after_mutation`, ни какой-либо сайт записи
  publisher-а не ждёт.
