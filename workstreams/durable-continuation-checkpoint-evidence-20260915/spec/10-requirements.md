...
- **Синхронный ack mutation-checkpoint-а у подкоманд без платного вызова.**
  ...
  платным вызовом добавляется граница перед ним; у `restore` — граница
  перед первым чтением store, потому что решение, принятое по
  недоставленному состоянию, тихо теряет чужую правку. Неизменным остаётся
