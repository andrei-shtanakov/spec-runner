...
- **Синхронный ack mutation-checkpoint-а у подкоманд без платного вызова.**
  ...
  не являющихся (harness status flip), а на пути «crash → restore» цели не
  достигает без дополнительной точки ожидания. Объём вынесен отдельной
  задачей (spec-runner#528) со всем, что о нём установлено.
