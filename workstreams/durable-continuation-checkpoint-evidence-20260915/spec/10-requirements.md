...
- **Порядок проверок (все — до записи в каталог):** contract version →
  ...
  **acknowledged** checkpoint прогона (частично доставленный набор ключей
  ...
  прогона ни один прогон не дошёл ни до платного вызова, ни до своего
  завершения — то есть доставить недоставленное было
  некому, — в пределе потому, что каталога и машины больше нет и
  pending-outbox уехал вместе с ними.
