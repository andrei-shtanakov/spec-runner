...
- behaviour-spec
upstream_hashes:
  requirements: b2d1ad530382dc341c789051218e65f589bb0663
  behaviour-spec: f63e955709916ee3bd5b4b9b955c15ec68e6de91
---
...
Точек drain по-прежнему три (Q-05), четвёртой доставка не заводит — и
...
места, и оба — не `record_*`, так что `after_mutation` не зовут. Первое:
