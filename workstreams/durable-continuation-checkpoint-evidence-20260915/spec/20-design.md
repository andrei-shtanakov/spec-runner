...
его **раньше собственных** записей — и потому раньше трёх событий, на
которых состояние читают: раньше своего платного вызова, раньше выбора
задачи и раньше своего успешного завершения (§ 3.5; «прежде любой другой
работы» резолюция не требует — важно, что процесс не решает и не тратит).
