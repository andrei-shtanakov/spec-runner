...
- acceptance
upstream_hashes:
  design: 69f89b8732745197542f5f2119287da46ab7cc3e
  acceptance: ffe405600a20b9e9e21baf195357717373818d5a
---
...
блокирующего прогона** (собственная запись текущего invocation не в счёт;
прогон с checkpoint-ом, но заблокированный более поздним, — петля, не
выход). Кандидата нет — отказ говорит это прямо, называет блокирующий
`run_id` и выхода не предлагает.
