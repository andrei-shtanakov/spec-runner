...
`restore` — раньше первой из семи проверок и раньше выбора материала, тот
же таймаут, `--into` остаётся пустым (решение владельца 2026-09-20), причём сайт перед closure —
