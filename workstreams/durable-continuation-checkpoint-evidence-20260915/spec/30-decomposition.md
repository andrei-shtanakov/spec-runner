...
- acceptance
upstream_hashes:
  design: fef0201b433bee31e6edac427b1940bfefebafbc
...
принадлежит только **знак**: последний And BEH-11 — чужой checkpoint у
двойника раньше checkpoint-а двери и раньше её кода выхода, на
последовательности FR-05 «дверь → restore». Без него дверь, прошедшая мимо
