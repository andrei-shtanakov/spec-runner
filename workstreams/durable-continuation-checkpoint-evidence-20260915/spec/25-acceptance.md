...
столько, сколько сайтов правила Q-05 он проходит (для `run` это (а) и
(б)), и число mutation подкоманды его не увеличивает. Цену гейта перед closure меряет AC-41 (бенчмарк), не этот
критерий.
