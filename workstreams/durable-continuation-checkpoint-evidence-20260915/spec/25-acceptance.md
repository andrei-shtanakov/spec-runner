...
каталоге отправляет его раньше своих записей и раньше трёх событий, на
которых состояние читают, — раньше своего платного вызова, раньше выбора
задачи и раньше своего успешного завершения, — с тем же `checkpoint_id` и
идемпотентно. Предъявлено на трёх прогонах, каждый накрывает своё событие
