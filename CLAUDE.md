...
| `cli_plan.py` | ~325 | Interactive planning: `cmd_plan` with both interactive and `--full` pipeline modes |
...
| `task.py` | ~490 | Task dataclass, regex parsing, dependency resolution, status management |
