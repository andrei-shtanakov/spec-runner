...
| `git_ops.py` | ~190 | Git operations: branch creation, main branch detection, `ensure_on_main_branch`, test file mapping; `uncommitted_work_paths` (#229 — non-runtime dirt, for reporting work an agent stranded in the tree, never a guard) |
