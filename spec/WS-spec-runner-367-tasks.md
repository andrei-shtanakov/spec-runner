...
- **Q-09 — где живёт отображение `(RunOutcome, SelectionProof,
  ...
  четыре случая: отсутствующая evidence, недостижимое окружение,
  недостижимый SHA, композитная test_command (minor круга 6: НЕ «весь
...
- [ ] проверка группы: tests/test_verify_gates.py (kind: integration) зелёные на BEH-25, BEH-28, BEH-29
...
verify-first в обеих конфигурациях + аудит каждого сайта чтения режима —
Q-01/FR-17: третье значение не читается как «гарантий нет»). Выделен из
TASK-009 и поставлен ПЕРЕД TASK-008: red-гейт обязан спрашиваться по
evidence, что невозможно до регистрации (major кругов 5–6).
